...
(function() {
    ...
    define(function() {
        ...
        : typeof process !== "undefined" && process.versions && process.versions.node ? (k = require.nodeRequire("fs"),
        h = function(a, b) {
            b(k.readFileSync(a, "utf8"))
        }
        ) : typeof Packages !== "undefined" && (h = function(a, b) {
            var c = new java.io.File(a), g = java.lang.System.getProperty("line.separator"), c = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(c),"utf-8")), d, f, e = "";
            try {
        ...
        return e = {
            ...
            parseName: function(a) {
                var b = !1
                  ...
                  , c = a.indexOf("!");
                c !== -1 && (b = a.substring(c + 1, a.length),
                b = b === "strip",
                a = a.substring(0, c));
                return {
                    moduleName: e,
